...
#Read the dataset----
titanic<-read.csv("C:/Users/mayan/SkillEdge/Analytics/Tutorials/Tutorial 4/T4_titanic.csv",header = T)
...
#Data clean up to be done as follows: Replace "?" with "NA" in the dataset:
...
##t1<-na.omit(titanic)
##View(t1)
#Drop the insignificant variables: home.dest,cabin, name, X and ticket.
...
#Convert few cont var from character to numeric----
...
#In both dataset, the amount of survivors is the same, about 40 percent, hence, randomization process while dividing the dataset into test & train has been done correctly.
